Instance: EnoxaparinBecat8000IEinjektion-SE-PLC-PackageProductDef
InstanceOf: PackagedProductDefinition
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-24T16:51:08.584+00:00"
* extension.url = "http://ema.europa.eu/fhir/extension/containedItemQuantity"
* extension.valueQuantity = 10 http://spor.ema.europa.eu/v1/lists/200000000014#200000002150 "Syringe"
* packageFor = Reference(EnoxaparinBecat8000IEinjektion-SE-PLC-MedicinalProductDef)
* description = "Förfylld spruta, 10 st (med automatiskt nålskydd)"
...
* package.package.containedItem.item.reference.reference = "ManufacturedItemDefinition/EnoxaparinBecat8000IEinjektion-SE-PLC-ManufacturedItemDef"
* package.package.containedItem.amount.value = 0.8
