...
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-15T18:56:08.915+00:00"
* status = #active
* for[0] = Reference(MetforminAuro-1000mg-Tablet-SE-BS-MedicinalProductDefinition)
* for[+] = Reference(MetforminAuro-1000mg-Tablet-SE-BS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/MetforminAuro-1000mg-Tablet-SE-BS-AdministrableProductDef)
