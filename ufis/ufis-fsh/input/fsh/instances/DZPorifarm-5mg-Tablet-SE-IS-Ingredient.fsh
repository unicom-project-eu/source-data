Instance: DZPorifarm-5mg-Tablet-SE-IS-Ingredient
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-08T13:06:29.711+00:00"
* status = #active
* for[0] = Reference(DZPorifarm-5mg-Tablet-SE-IS-MedicinalProductDefinition)
* for[+] = Reference(DZPorifarm-5mg-Tablet-SE-IS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/DZPorifarm-5mg-Tablet-SE-IS-AdministrableProductDefinition)
