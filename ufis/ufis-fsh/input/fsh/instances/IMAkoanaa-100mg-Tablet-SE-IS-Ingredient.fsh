...
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-13T16:21:56.779+00:00"
* status = #active
* for[0] = Reference(IMAkoanaa-100mg-Tablet-SE-IS-MedicinalProductDefinition)
* for[+] = Reference(IMAkoanaa-100mg-Tablet-SE-IS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/IMAkoanaa-100mg-Tablet-SE-IS-AdministrableProductDefinition)
