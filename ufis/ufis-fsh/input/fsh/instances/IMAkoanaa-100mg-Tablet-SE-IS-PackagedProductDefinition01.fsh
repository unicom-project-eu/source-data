Instance: IMAkoanaa-100mg-Tablet-SE-IS-PackagedProductDefinition01
InstanceOf: PackagedProductDefinition
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-13T16:21:56.738+00:00"
* extension.url = "http://ema.europa.eu/fhir/extension/containedItemQuantity"
* extension.valueQuantity = 10 http://spor.ema.europa.eu/v1/lists/200000000014#200000002152 "Tablet"
* packageFor = Reference(IMAkoanaa-100mg-Tablet-SE-IS-MedicinalProductDefinition)
* description = "Blister, 120 tabletter"
...
* package.package.containedItem.item.reference.reference = "ManufacturedItemDefinition/IMAkoanaa-100mg-Tablet-SE-IS-ManufacturedItemDefinition"
