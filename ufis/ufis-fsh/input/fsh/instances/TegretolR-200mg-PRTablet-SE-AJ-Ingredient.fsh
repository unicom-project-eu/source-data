Instance: TegretolR-200mg-PRTablet-SE-AJ-Ingredient
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-09T12:47:42.969+00:00"
* status = #active
* for[0] = Reference(TegretolR-200mg-PRTablet-SE-AJ-MedicinalProductDefinition)
* for[+] = Reference(TegretolR-200mg-PRTablet-SE-AJ-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinitionTegretolR-200mg-PRTablet-SE-AJ-AdministrableProductDefinition)
