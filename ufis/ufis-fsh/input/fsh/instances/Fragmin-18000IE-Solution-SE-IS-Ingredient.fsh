Instance: Fragmin-18000IE-Solution-SE-IS-Ingredient
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-27T11:54:37.777+00:00"
* status = #active
* for[0] = Reference(Fragmin-18000IE-Solution-SE-IS-MedicinalProductDefinition)
* for[+] = Reference(Fragmin-18000IE-Solution-SE-IS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/Fragmin-18000IE-Solution-SE-IS-AdministrableProductDefinition)
...
* substance.strength.referenceStrength.strengthRatio.numerator = 18000 http://spor.ema.europa.eu/v1/lists/100000110633#100000110671 "international unit(s)"
