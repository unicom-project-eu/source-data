Instance: Fragmin-12500IE-Solution-SE-IS-Ingredient
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-27T11:47:08.217+00:00"
* status = #active
* for[0] = Reference(Fragmin-12500IE-Solution-SE-IS-MedicinalProductDefinition)
* for[+] = Reference(Fragmin-12500IE-Solution-SE-IS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/Fragmin-12500IE-Solution-SE-IS-AdministrableProductDefinition)
