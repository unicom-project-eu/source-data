Instance: IMAmylan-400mg-Tablet-SE-IS-Ingredient
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-13T16:38:04.771+00:00"
* status = #active
* for[0] = Reference(IMAmylan-400mg-Tablet-SE-IS-MedicinalProductDefinition)
* for[+] = Reference(IMAmylan-400mg-Tablet-SE-IS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/IMAmylan-400mg-Tablet-SE-IS-AdministrableProductDefinition)
