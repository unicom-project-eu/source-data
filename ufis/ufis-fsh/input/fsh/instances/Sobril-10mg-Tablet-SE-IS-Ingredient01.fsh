Instance: Sobril-10mg-Tablet-SE-IS-Ingredient01
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-10T06:46:15.295+00:00"
* status = #active
* for[0] = Reference(Sobril-10mg-Tablet-SE-IS-MedicinalProductDefinition)
* for[+] = Reference(Sobril-10mg-Tablet-SE-IS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/Sobril-10mg-Tablet-SE-IS-AdministrableProductDefinition)
