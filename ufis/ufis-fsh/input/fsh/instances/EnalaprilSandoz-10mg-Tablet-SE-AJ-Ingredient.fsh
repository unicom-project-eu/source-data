...
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-13T17:07:05.053+00:00"
* status = #active
* for[0] = Reference(EnalaprilSandoz-10mg-Tablet-SE-AJ-MedicinalProductDefinition)
* for[+] = Reference(EnalaprilSandoz-10mg-Tablet-SE-AJ-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/EnalaprilSandoz-10mg-Tablet-SE-AJ-AdministrableProductDef)
