...
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-09T12:55:52.958+00:00"
* status = #active
* for[0] = Reference(TrimonilR-400mg-PRTablet-SE-AJ-MedicinalProductDefinition)
* for[+] = Reference(TrimonilR-400mg-PRTablet-SE-AJ-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinitionTrimonilR-400mg-PRTablet-SE-AJ-AdministrableProductDefinition)
