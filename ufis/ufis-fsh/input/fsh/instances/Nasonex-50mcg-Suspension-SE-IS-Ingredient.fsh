...
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-17T06:45:59.647+00:00"
* status = #active
* for[0] = Reference(Nasonex-50mcg-Suspension-SE-IS-MedicinalProductDefinition)
* for[+] = Reference(Nasonex-50mcg-Suspension-SE-IS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/Nasonex-50mcg-Suspension-SE-IS-AdministrableProductDefinition)
