Instance: Fragmin-2500IEml-Solution-SE-IS-PackagedProductDefinition
InstanceOf: PackagedProductDefinition
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-27T09:56:10.619+00:00"
* extension.url = "http://ema.europa.eu/fhir/extension/containedItemQuantity"
* extension.valueQuantity = 10 http://spor.ema.europa.eu/v1/lists/200000000014#200000002158 "Vial"
* packageFor = Reference(Fragmin-2500IEml-Solution-SE-IS-MedicinalProductDefinition)
* description = "Injektionsflaska, 10 x 4 ml"
...
* package.package.containedItem.item.reference.reference = "ManufacturedItemDefinition/Fragmin-2500IEml-Solution-SE-IS-ManufacturedItemDefinition"
