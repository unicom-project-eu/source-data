Instance: CefStragen-750mg-Powder-SE-IS-PackagedProductDefinition
InstanceOf: PackagedProductDefinition
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-10T05:51:57.711+00:00"
* extension.url = "http://ema.europa.eu/fhir/extension/containedItemQuantity"
* extension.valueQuantity = 10 http://spor.ema.europa.eu/v1/lists/200000000014#200000002158 "Vial"
* packageFor = Reference(CefStragen-750mg-Powder-SE-IS-MedicinalProductDefinition)
* description = "Injektionsflaska, 10 st (10 x 750 mg)"
...
* package.package.containedItem.item.reference.reference = "ManufacturedItemDefinition/CefStragen-750mg-Powder-SE-IS-ManufacturedItemDefinition"
