Instance: DZPorifarm-10mg-Solution-SE-IS-Ingredient
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-08T12:56:26.545+00:00"
* status = #active
* for[0] = Reference(DZPorifarm-10mg-Solution-SE-IS-MedicinalProductDefinition)
* for[+] = Reference(DZPorifarm-10mg-Solution-SE-IS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/DZPorifarm-10mg-Solution-SE-IS-AdministrableProductDefinition)
