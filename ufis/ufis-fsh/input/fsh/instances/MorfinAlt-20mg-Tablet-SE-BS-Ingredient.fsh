Instance: MorfinAlt-20mg-Tablet-SE-BS-Ingredient
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-28T06:30:03.807+00:00"
* status = #active
* for[0] = Reference(MorfinAlt-20mg-Tablet-SE-BS-MedicinalProductDefinition)
* for[+] = Reference(MorfinAlt-20mg-Tablet-SE-BS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/MorfinAlt-20mg-Tablet-SE-BS-AdministrableProductDef)
...
* substance.strength.referenceStrength.strengthRatio.numerator = 15.19 https://spor.ema.europa.eu/v1/lists/100000110633#100000110655 "milligram(s)"
