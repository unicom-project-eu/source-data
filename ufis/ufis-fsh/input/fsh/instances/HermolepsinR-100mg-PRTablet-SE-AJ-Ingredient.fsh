...
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-01T14:55:14.084+00:00"
* status = #active
* for[0] = Reference(HermolepsinR-100mg-PRTablet-SE-AJ-MedicinalProductDefinition)
* for[+] = Reference(HermolepsinR-100mg-PRTablet-SE-AJ-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinitionHermolepsinR-100mg-PRTablet-SE-AJ-AdministrableProductDefinition)
