Instance: AtomoxetinGlenmark-10mg-Capsule-SE-AJ-Ingredient
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-08-23T19:49:49.161+00:00"
* status = #active
* for[0] = Reference(AtomoxetinGlenmark-10mg-Capsule-SE-AJ-MedicinalProductDef)
* for[+] = Reference(AtomoxetinGlenmark-10mg-Capsule-SE-AJ-ManufacturedItemDef)
* for[+] = Reference(AdministrableProductDefinitionAtomoxetinGlenmark-10mg-Capsule-SE-AJ-AdministrableProductDef)
