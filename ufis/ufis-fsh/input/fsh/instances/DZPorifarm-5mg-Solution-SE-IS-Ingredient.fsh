Instance: DZPorifarm-5mg-Solution-SE-IS-Ingredient
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-08T12:51:47.926+00:00"
* status = #active
* for[0] = Reference(DZPorifarm-5mg-Solution-SE-IS-MedicinalProductDefinition)
* for[+] = Reference(DZPorifarm-5mg-Solution-SE-IS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/DZPorifarm-5mg-Solution-SE-IS-AdministrableProductDefinition)
