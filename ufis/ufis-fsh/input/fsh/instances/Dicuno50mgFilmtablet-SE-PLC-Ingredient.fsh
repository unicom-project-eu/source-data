Instance: Dicuno50mgFilmtablet-SE-PLC-Ingredient
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-13T17:26:17.309+00:00"
* status = #active
* for[0] = Reference(Dicuno50mgFilmtablet-SE-PLC-MedicinalProductDef)
* for[+] = Reference(Dicuno50mgFilmtablet-SE-PLC-ManufacturedItemDef)
* for[+] = Reference(AdministrableProductDefinition/Dicuno50mgFilmtablet-SE-PLC-AdminProductDef)
