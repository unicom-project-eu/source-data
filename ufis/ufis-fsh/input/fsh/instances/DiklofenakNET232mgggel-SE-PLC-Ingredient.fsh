...
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-24T17:24:32.879+00:00"
* status = #active
* for[0] = Reference(DiklofenakNET232mgggel-SE-PLC-MedicinalProductDef)
* for[+] = Reference(DiklofenakNET232mgggel-SE-PLC-ManufacturedItemDef)
* for[+] = Reference(AdministrableProductDefinition/DiklofenakNET232mgggel-SE-PLC-AdminProductDef)
