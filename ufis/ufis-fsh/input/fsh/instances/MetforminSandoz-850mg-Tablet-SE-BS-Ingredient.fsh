Instance: MetforminSandoz-850mg-Tablet-SE-BS-Ingredient
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-15T19:04:33.918+00:00"
* status = #active
* for[0] = Reference(MetforminSandoz-850mg-Tablet-SE-BS-MedicinalProductDefinition)
* for[+] = Reference(MetforminSandoz-850mg-Tablet-SE-BS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/MetforminSandoz-850mg-Tablet-SE-BS-AdministrableProductDef)
...
* substance.strength.referenceStrength.strengthRatio.numerator = 662.9 https://spor.ema.europa.eu/v1/lists/100000110633#100000110655 "milligram(s)"
