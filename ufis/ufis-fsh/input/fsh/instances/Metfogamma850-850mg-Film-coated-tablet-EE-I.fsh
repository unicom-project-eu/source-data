Instance: Metfogamma850-850mg-Film-coated-tablet-EE-I
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-08-14T19:07:09.745+00:00"
* status = #active
* for[0] = Reference(Metfogamma850-850mg-Film-coated-tablet-EE-MPD)
* for[+] = Reference(Metfogamma850-850mg-Film-coated-tablet-EE-MID)
* for[+] = Reference(AdministrableProductDefinition/Metfogamma850-850mg-Film-coated-tablet-EE-APD)
* role = $100000072050_1#100000072072 "Active"
* substance.code.concept = $SubstanceDefinition_1#100000091366 "Metformin hydrochloride"
