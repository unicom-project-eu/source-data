Instance: Yasminelle-tablet-SE-AJ-PackagedProductDefinition
InstanceOf: PackagedProductDefinition
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-11-16T16:23:04.134+00:00"
* extension.url = "http://ema.europa.eu/fhir/extension/containedItemQuantity"
* extension.valueQuantity = 63 http://spor.ema.europa.eu/v1/lists/200000000014#200000002152 "tablet"
* packageFor = Reference(Yasminelle-tablet-SE-AJ-MedicinalProductDefinition)
* description = "Blister, 3 x 21 tabletter"
...
* package.package.containedItem.item.reference.reference = "ManufacturedItemDefinition/Yasminelle-tablet-SE-AJ-ManufacturedItemDefinition01"
