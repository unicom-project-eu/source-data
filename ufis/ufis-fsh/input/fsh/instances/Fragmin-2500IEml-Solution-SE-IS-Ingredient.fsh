Instance: Fragmin-2500IEml-Solution-SE-IS-Ingredient
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-27T09:56:10.642+00:00"
* status = #active
* for[0] = Reference(Fragmin-2500IEml-Solution-SE-IS-MedicinalProductDefinition)
* for[+] = Reference(Fragmin-2500IEml-Solution-SE-IS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/Fragmin-2500IEml-Solution-SE-IS-AdministrableProductDefinition)
