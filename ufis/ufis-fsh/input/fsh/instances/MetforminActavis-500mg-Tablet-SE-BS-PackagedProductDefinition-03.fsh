Instance: MetforminActavis-500mg-Tablet-SE-BS-PackagedProductDefinition-03
InstanceOf: PackagedProductDefinition
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-15T18:41:33.397+00:00"
* extension[0].url = "http://ema.europa.eu/fhir/extension/containedItemQuantity"
* extension[=].valueQuantity = 300 http://spor.ema.europa.eu/v1/lists/200000000014#200000002152 "Tablet"
...
* package.package.containedItem.item.reference.reference = "ManufacturedItemDefinition/MetforminActavis-500mg-Tablet-SE-BS-ManufacturedItemDefinition"
* package.package.containedItem.amount.value = 300
