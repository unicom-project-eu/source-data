Instance: Xylocain-Dental-Adrenalin-SE-AJ-PackagedProductDefinition02
InstanceOf: PackagedProductDefinition
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-11-10T16:23:59.863+00:00"
* extension.url = "http://ema.europa.eu/fhir/extension/containedItemQuantity"
* extension.valueQuantity = 100 http://spor.ema.europa.eu/v1/lists/200000000014#200000002114 "cartridge"
* packageFor = Reference(Xylocain-Dental-Adrenalin-SE-AJ-MedicinalProductDefinition)
* description = "Cylinderampull (självaspirerande), 100 x 1,8 ml"
...
* package.package.containedItem.item.reference.reference = "ManufacturedItemDefinition/Xylocain-Dental-Adrenalin-SE-AJ-ManufacturedItemDefinition"
* package.package.containedItem.amount.value = 1.8
