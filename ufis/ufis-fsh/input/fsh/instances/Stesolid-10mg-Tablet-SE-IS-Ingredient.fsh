Instance: Stesolid-10mg-Tablet-SE-IS-Ingredient
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-08T13:39:10.154+00:00"
* status = #active
* for[0] = Reference(Stesolid-10mg-Tablet-SE-IS-MedicinalProductDefinition)
* for[+] = Reference(Stesolid-10mg-Tablet-SE-IS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/Stesolid-10mg-Tablet-SE-IS-AdministrableProductDefinition)
