Instance: Glytrin04mgdossublingualspray-SE-PLC-PackageProductDef
InstanceOf: PackagedProductDefinition
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-13T16:15:22.101+00:00"
* extension.url = "http://ema.europa.eu/fhir/extension/containedItemQuantity"
* extension.valueQuantity = 1 http://spor.ema.europa.eu/v1/lists/200000000014#200000022801 "Canister"
* packageFor = Reference(Glytrin04mgdossublingualspray-SE-PLC-MedicinalProductDef)
...
* package.containedItem.item.reference.reference = "ManufacturedItemDefinition/ProductnameStrengthPharmaceuticaldoseform-SE-PLC-ManufacturedItemDef"
