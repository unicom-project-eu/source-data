...
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-16T09:10:03.154+00:00"
* status = #active
* for[0] = Reference(MetforminSandoz-1000mg-Tablet-SE-BS-MedicinalProductDefinition)
* for[+] = Reference(MetforminSandoz-1000mg-Tablet-SE-BS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/MetforminSandoz-1000mg-Tablet-SE-BS-AdministrableProductDef)
