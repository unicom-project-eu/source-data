Instance: IMAkrkadd-100mg-Tablet-SE-IS-Ingredient
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-27T07:24:20.396+00:00"
* status = #active
* for[0] = Reference(IMAkrkadd-100mg-Tablet-SE-IS-MedicinalProductDefinition)
* for[+] = Reference(IMAkrkadd-100mg-Tablet-SE-IS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/IMAkrkadd-100mg-Tablet-SE-IS-AdministrableProductDefinition)
