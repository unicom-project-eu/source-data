...
* package.package[=].containedItem.item.reference.reference = "ManufacturedItemDefinition/Zeldox20mgml2-SE-PLC-ManufacturedItemDef01"
...
* package.package[=].shelfLifeStorage.specialPrecautionsForStorage[=].coding.code = "100000073420"
* package.package[=].shelfLifeStorage.specialPrecautionsForStorage[=].coding.display = "Do not freeze"
* package.package[=].containedItem.item.reference.reference = "ManufacturedItemDefinition/Zeldox20mgml2-SE-PLC-ManufacturedItemDef02"
* package.package[=].containedItem.amount.value = 1
