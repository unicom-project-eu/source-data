Instance: Sendolor-1mgml-Solution-SE-BS-Ingredient
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-28T07:09:46.74+00:00"
* status = #active
* for[0] = Reference(Sendolor-1mgml-Solution-SE-BS-MedicinalProductDefinition)
* for[+] = Reference(Sendolor-1mgml-Solution-SE-BS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/Sendolor-1mgml-Solution-SE-BS-AdministrableProductDefinition)
