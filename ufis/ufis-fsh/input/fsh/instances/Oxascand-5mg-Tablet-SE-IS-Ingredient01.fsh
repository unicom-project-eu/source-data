Instance: Oxascand-5mg-Tablet-SE-IS-Ingredient01
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-10T06:35:11.464+00:00"
* status = #active
* for[0] = Reference(Oxascand-5mg-Tablet-SE-IS-MedicinalProductDefinition)
* for[+] = Reference(Oxascand-5mg-Tablet-SE-IS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/Oxascand-5mg-Tablet-SE-IS-AdministrableProductDefinition)
...
* substance.strength.referenceStrength.substance.concept = $SubstanceDefinition_1#100000091921 "Oxazepam"
