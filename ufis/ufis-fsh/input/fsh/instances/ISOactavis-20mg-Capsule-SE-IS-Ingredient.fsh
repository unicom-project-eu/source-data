Instance: ISOactavis-20mg-Capsule-SE-IS-Ingredient
InstanceOf: Ingredient
Usage: #inline
* meta.versionId = "1"
* meta.lastUpdated = "2022-10-27T07:50:21.889+00:00"
* status = #active
* for[0] = Reference(ISOactavis-20mg-Capsule-SE-IS-MedicinalProductDefinition)
* for[+] = Reference(ISOactavis-20mg-Capsule-SE-IS-ManufacturedItemDefinition)
* for[+] = Reference(AdministrableProductDefinition/ISOactavis-20mg-Capsule-SE-IS-AdministrableProductDefinition)
